...
**Projet** : `lianazel.github.io` · **Type** : EVOL (`/ship`) · **Version du prompt** : v2 · **Date** : 9 août 2026
**Rédacteur** : Cowork (Tech Lead) · **Destinataire** : Claude Code
**Statut** : PÉRIMÉ — remplacé avant exécution par `EVOL_menu-debordement_v3.md` (invariant du contrôle 9 faux)
